...
<script>
	...
	$(document).ready(function() {
		...
		*/		
		...
		var button = '<span class="fc-button fc-button-month fc-state-default fc-corner-left fc-corner-right fc-state-active" onclick="alert(23);"><?php echo $button_title ?></span>';
