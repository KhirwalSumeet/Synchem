...
<script type="text/javascript">
    var app = angular.module("chemist", []);
</script>
<div id="page-wrapper" ng-app="chemist">
    <div ng-controller="viewchemist">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> View Chemist
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <!-- /#page-wrapper -->
<script type="text/javascript">
app.controller("viewchemist", function($scope) {
    $.ajax
    ({
          type: "GET",
    ...
    $scope.generate=function (){
        $scope.export($scope.data,"ChemistReport",true);
    };
});
</script>
